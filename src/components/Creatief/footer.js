...
import styles from '@/styles/Creatief/footer.module.css';
...
export default function Footer() {
  ...
  return (
    <footer className={styles.footer}>
      ...
      <Link href="/Creatief/home" passHref className={`${styles.footerLink} ${activeIcon === 'home' && styles.active}`} onClick={() => handleIconClick('home')}>
  <Image src={activeIcon === 'home' ? "/home-active.svg" : "/home.svg"} alt="Home" className={styles.footerIcon} width={300} height={40}/>
</Link>
<Link href="/Creatief/zoeken" passHref className={`${styles.footerLink} ${activeIcon === 'zoeken' && styles.active}`} onClick={() => handleIconClick('zoeken')}>
  <Image src={activeIcon === 'zoeken' ? "/search-active.svg" : "/search.svg"} alt="Zoeken" className={styles.footerIcon} width={300} height={40}/>
</Link>
<Link href="/Creatief/favorites" passHref className={`${styles.footerLink} ${activeIcon === 'favorites' && styles.active}`} onClick={() => handleIconClick('favorites')}>
...
<Link href="/Creatief/map" passHref className={`${styles.footerLink} ${activeIcon === 'map' && styles.active}`} onClick={() => handleIconClick('map')}>
